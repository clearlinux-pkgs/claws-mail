...
Source0  : http://www.claws-mail.org/download.php?file=releases/claws-mail-3.14.1.tar.gz
Summary  : Claws Mail
...
%prep
%setup -q -n claws-mail-3.14.1

%build
export LANG=C
export SOURCE_DATE_EPOCH=1484921974
...
/usr/include/claws-mail/plugins/claws-mail/ical.h
